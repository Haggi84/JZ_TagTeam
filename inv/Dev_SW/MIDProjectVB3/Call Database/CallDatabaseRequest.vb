...
Public Class CallDatabaseRequest
    Inherits ChangeRequest

    Private oAddIn As Inventor.Application
    Private oServer As MidAddInServer

    Private oCallDatabaseCmd As CallDatabaseCommand


    ' Constructor
    '***************************************************************************************************************
    Public Sub New(ByVal CallDatabaseCmd As CallDatabaseCommand, _
                   ByVal addIn As Inventor.Application, _
                   ByVal server As MidAddInServer)

        Me.oAddIn = addIn
        Me.oServer = server
        Me.oCallDatabaseCmd = CallDatabaseCmd
