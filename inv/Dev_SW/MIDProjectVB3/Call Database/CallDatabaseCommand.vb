...
Public Class CallDatabaseCommand
    Inherits Command
    ...
    Public Overrides Sub StartCommand()
        ...
        'start_lb()
        MsgBox("Datenbank wird gestartet")
        Process.Start("https://kain.faps.uni-erlangen.de/webmidis")
    ...
    Public Overrides Sub ExecuteCommand()
        ...
        Dim oCallDatabaseRequest As New CallDatabaseRequest(Me, MidAddIn, oServer)
        MyBase.ExecuteChangeRequest(oCallDatabaseRequest, "MidAddIn:CallDatabaseRequest", MidAddIn.ActiveDocument)
