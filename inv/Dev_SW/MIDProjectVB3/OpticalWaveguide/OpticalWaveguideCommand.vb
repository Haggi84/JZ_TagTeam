...
Public Class OpticalWaveguideCommand
    Inherits Command
    ...
    Public Overrides Sub StartCommand()
        ...
        Process.Start("C:\Users\jozeitler\AppData\Roaming\Autodesk\Inventor 2015\Addins\OPTAVER_Projekt_Leiterbahn_VB.exe")
    ...
    Public Overrides Sub ExecuteCommand()
        ...
        Dim oOpticalWaveguideRequest As New OpticalWaveguideRequest(Me, MidAddIn, oServer)
        MyBase.ExecuteChangeRequest(oOpticalWaveguideRequest, "MidAddIn:OpticalWaveguideRequest", MidAddIn.ActiveDocument)
        Process.Start("D:\Projekte\Projekt Optaver\Optaver_SVN\Projektorganisation\Teilprojekt_6_Design\Software\OPTAVER_Dev\Ressources\DLL\bin\OPTAVER_Inventor_ADDIN_VB.exe")

        'Dim PL As New Projekt_Leiterbahn.Form_Bahnerstellen
        'PL.ShowDialog()
