...
'#######################################################
' Boundary Representation Export Class
'#######################################################

Public Class BRepExport
...
#End Region
    ...
    ' Constructor
    '**********************************************************************************************************
    Public Sub New(ByRef addIn As Inventor.Application, _
    ...
    ' ReadBRepAI (based on original ReadBRepAI from project partner)
    '**********************************************************************************************************
    Public Sub ReadBRepAI(oOccurrence As ComponentOccurrence, _
                          workDirectory As String, _
                          precisionOfAngles As String, _
                          precisionOfLengths As String, _
                          unitOfAngles As String, _
                          unitOfLengths As String)

        Me.workDir = workDirectory
        Me.precisionOfAngles = precisionOfAngles
        Me.precisionOfLengths = precisionOfLengths
        Me.unitOfAngles = unitOfAngles

        ' Get export data
        'oServer.Commands.PlaceCommand.GetExportData(workDir, precisionOfAngles, precisionOfLengths, unitOfAngles, unitOfLengths)
        ...
        Try
            ...
            oXMLWriter.WriteAttributeString("unitOfLengths", unitOfLengths)
            oXMLWriter.WriteAttributeString("precisionOfLengths", precisionOfLengths)
    ...
    '********************************************************************************************************************
    Private Function detObjectLists(ByVal oCompOcc As ComponentOccurrence, _
    ...
    ' Set Attributes
    '********************************************************************************************************************
    Private Sub SetAttributes(ByRef oVertices As Vertices, _
                              ByRef oEdges As Edges, _
                              ByRef oFaces As Faces)
