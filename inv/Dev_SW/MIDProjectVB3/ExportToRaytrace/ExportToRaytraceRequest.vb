...
Public Class ExportToRaytraceRequest
    Inherits ChangeRequest

    Private oAddIn As Inventor.Application
    Private oServer As MidAddInServer

    Private oExportToRaytraceCmd As ExportToRaytraceCommand


    ' Constructor
    '***************************************************************************************************************
    Public Sub New(ByVal ExportToRaytraceCmd As ExportToRaytraceCommand, _
                   ByVal addIn As Inventor.Application, _
                   ByVal server As MidAddInServer)

        Me.oAddIn = addIn
        Me.oServer = server
        Me.oExportToRaytraceCmd = ExportToRaytraceCmd
