...
Public Class ExportToRaytraceCommand
    Inherits Command
    ...
    Public Overrides Sub StartCommand()
        ...
        'start_lb()
        MsgBox("Export in AUT Format wird gestartet")

        Process.Start("D:\Projekte\Projekt Optaver\Optaver_SVN\Projektorganisation\Teilprojekt_6_Design\Software\OPTAVER_Dev\Dev_SW\OPTAVER_Exp_Raytrace\OPTAVER_Exp_Raytrace\bin\Debug\OPTAVER_Exp_Raytrace.exe")
    ...
    Public Overrides Sub ExecuteCommand()
        ...
        Dim oExportToRaytraceRequest As New ExportToRaytraceRequest(Me, MidAddIn, oServer)
        MyBase.ExecuteChangeRequest(oExportToRaytraceRequest, "MidAddIn:ExportToRaytraceRequest", MidAddIn.ActiveDocument)
