...
Public Class LoadProjectRequest
    ...
    ' Constructor
    '***************************************************************************************************************
    Public Sub New(ByVal loadProjectCmd As LoadProjectCommand, _
    ...
    Public Overrides Sub OnExecute(document As Document, _
        ...
        oAsmDoc.EnvironmentManager.SetCurrentEnvironment(oAddIn.UserInterfaceManager.Environments.Item("MidEnvironment"))
        ...
        oServer.CommandCollection.CircuitCarrierNode = oServer.Browser.CreateNode("Circuit Carrier")
        oServer.CommandCollection.CircuitBoardNode = oServer.Browser.CreateNode("Circuit Board")
