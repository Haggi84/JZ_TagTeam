...
Public Class PlaceCommand
    ...
    Private unitOfLength As String
    ...
    ' Get export data
    '***************************************************************************************************************
    Public Sub GetExportData(ByRef workDir As String, _
                             ByRef precOfAngles As String, _
                             ByRef precOfLength As String, _
                             ByRef unitOfAngles As String, _
                             ByRef unitOfLength As String)

        workDir = oServer.CommandCollection.WorkDirectory

        strFileName = Me.strFileName
        precOfAngles = Me.PrecisionOfAngles
        precOfLength = Me.PrecisionOfLength
        unitOfLength = Me.unitOfLength
