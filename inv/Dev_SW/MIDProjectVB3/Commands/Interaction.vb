...
Public Class Interaction
    ...
    ' Stop interaction --> Stop interaction events for the calling command
    '************************************************************************************************
    ...
    Public Sub EnableInteraction()
        ...
        Dim interactionType As InteractionTypeEnum
        ' go through the entire list and reregister the events in it 
        For i As Integer = 0 To oInteractionTypes.Count - 1
            interactionType = oInteractionTypes(i)
    ...
    ' Disable Interaction --> remove event handlers
    '************************************************************************************************
    ...
    Private Sub oKeyEvents_OnKeyPress(keyASCII As Integer)
